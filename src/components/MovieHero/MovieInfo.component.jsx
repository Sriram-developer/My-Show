           ...
           <PaymentModal setIsOpen={setIsOpen} isOpen={isOpen} price={price}/>
            <div className="flex flex-col gap-3 lg:gap-8">
                <div className="flex items-center gap-3 md:px-4">
                    ...
                    <span className="bg-msm-700 p-1 text-xs text-white  rounded-md">Streaming now</span>
                </div>
              ...
              <div className="text-white font-light flex flex-col gap-2 md:px-4">
                ...
                <div className="flex items-center gap-3 md:px-4 mx-2 md:w-screen lg:w-full ">
                    ...
                    <button onClick={buyMovies}  className="bg-red-600 w-full py-3 text-white font-semibold rounded-lg">Buy ₹399</button>
                </div>
              </div>
            </div>
        </>
