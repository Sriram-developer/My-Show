    ...
    return (
        ...
        <div className="text-white flex items-center justify-between">
            <div>
                ...
                <span className="text-gray-400 text-base flex items-center">Madurai <BiChevronRight/></span>
            </div>
...
const Navbar = () => {
    return ( <>
     <nav className="bg-msm-700 p-4">
         <div className="md:hidden">{/* For mobile devices*/}<NavSm/></div>
         <div className="hidden md:flex lg:hidden">{/* For medium devices*/}<NavMd/></div>
